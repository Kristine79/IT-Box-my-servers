    ...
    resources: {
      en: {
        translation: {
          ...
          "recent_projects": "New Projects",
          "recent_servers": "New Servers",
          ...
          "placeholder_name": "Example: StackBox",
          ...
          "paywall_desc": "We hope you enjoyed using StackBox! Your 14-day free trial has come to an end. Please choose a plan to continue.",
          ...
          "hero_title": "StackBox — A unified vault for all your infrastructure",
          ...
          "sign_in_email": "Sign in with email and password",
          "or": "or",
          "sign_in_title": "Sign in to your account",
          "tab_login": "Sign in",
          "tab_register": "Register",
          "create_account": "Create account",
          "back_to_methods": "Back to other sign-in methods",
          "password_placeholder": "Password",
          "password_register_placeholder": "Create password (min 6 chars)",
          "fill_email_password": "Please fill in email and password",
          "email_already_registered": "This email is already registered. Enter your password to sign in.",
          "close": "Close",
          "hide_password": "Hide password",
          "show_password": "Show password",
          "edit_project": "Edit project",
          "delete_project_title": "Delete project?",
          "delete_project_confirm": "This action cannot be undone.",
          "cancel": "Cancel",
          "delete": "Delete",
          ...
          "enter_email_confirm": "Enter your email to confirm",
          "link_sign_in_error": "Sign-in link error",
          "payment_failed": "Failed to create payment. Try again.",
          "payment_service_error": "Error connecting to payment service.",
...
"technical_support": "Technical support",
          ...
          "notifications_disabled_desc": "Turn them on in settings to see real-time updates.",
...
"close_popup": "Close",
      ...
      ru: {
        translation: {
          ...
          "stored_credentials": "Всего доступов",
          "recent_projects": "Новые проекты",
          "recent_servers": "Новые серверы",
          "system_overview": "Обзор IT-инфраструктуры",
          ...
          "placeholder_name": "Например: StackBox",
          ...
          "paywall_desc": "Надеемся, вам понравилось использовать StackBox! Ваш бесплатный 14-дневный пробный период подошел к концу. Для продолжения работы выберите тариф.",
          ...
          "hero_title": "StackBox — Единый сейф для всей вашей инфраструктуры",
          ...
          "sign_in_email": "Войти по email и паролю",
          "or": "или",
          "sign_in_title": "Войдите в аккаунт",
          "tab_login": "Войти",
          "tab_register": "Зарегистрироваться",
          "create_account": "Создать аккаунт",
          "back_to_methods": "← Назад к другим способам входа",
          "password_placeholder": "Пароль",
          "password_register_placeholder": "Придумайте пароль (мин. 6 символов)",
          "fill_email_password": "Заполните email и пароль",
          "email_already_registered": "Этот email уже зарегистрирован. Введите пароль и войдите.",
          "close": "Закрыть",
          "hide_password": "Скрыть пароль",
          "show_password": "Показать пароль",
          "edit_project": "Редактировать проект",
          "delete_project_title": "Удалить проект?",
          "delete_project_confirm": "Это действие нельзя отменить.",
          "cancel": "Отмена",
          "delete": "Удалить",
          "all_priorities": "Все приоритеты",
          "sorting": "Сортировка",
          "filter": "Фильтр",
          "any_stack": "Любой стэк",
          ...
          "enter_email_confirm": "Введите ваш email для подтверждения",
          "link_sign_in_error": "Ошибка входа по ссылке",
          "payment_failed": "Не удалось создать платёж. Попробуйте ещё раз.",
          "payment_service_error": "Ошибка подключения к платёжному сервису.",
          "redirecting": "Переход...",
...
"useful_bots": "Полезные Telegram боты",
          ...
          "notifications_disabled_desc": "Включите их в настройках, чтобы видеть обновления в реальном времени.",
          "open_settings": "Открыть настройки",
"close_popup": "Закрыть",
          "active": "Включено",
          "disabled": "Отключено",
          "open_search": "Открыть поиск (Ctrl+K)",
          "search_ctrl_k": "Поиск (Ctrl+K)",
          "notification_settings": "Настройки уведомлений",
          "close_notifications": "Закрыть уведомления",
