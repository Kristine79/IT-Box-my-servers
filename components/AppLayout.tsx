             ...
             {navItems.map((item) => {
               ...
               <Link
                 ...
                 className={cn(
                   ...
                   desktopSidebarOpen ? "px-3" : "px-0 justify-center",
